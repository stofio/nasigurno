...
//email
delete_post_meta($post_id, 'dodatnih_email');
...
//radno_vreme
delete_post_meta($post_id, 'radno_vreme');
...
$gallArray = array();
//add old imgs
if($_POST['oldGallImgs']) {
    $imgIdsArr = json_decode($_POST['oldGallImgs']);
    $gallArray = array_merge($gallArray,$imgIdsArr);
}
//add new images
